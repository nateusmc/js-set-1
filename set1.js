...
// whoAmI("Jesse", 27);
//5
let yearOfBirth = function(age){ return 2017 - age; };
let whoAmI = function (name, age) { let yob = yearOfBirth(age); console.log(Hi, my name is ${name} and I'm ${age} years old); console.log(I was born in ${yob}); };
whoAmI("Jesse", 27);
//6
